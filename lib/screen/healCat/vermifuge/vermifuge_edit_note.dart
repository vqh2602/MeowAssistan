...
class EditWormScreen extends StatefulWidget {
  final bool newNote;
  final Worm? bmi;
  final int? index;
  int? id;
  EditWormScreen({this.bmi, this.index, required this.newNote, this.id});
...
class _MyEditCatScreen extends State<EditWormScreen> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              // );
                              widget.newNote
                                  ? BlocProvider.of<WormBloc>(context).add(
                                  WormAddEvent(
                                          bmi: Worm(
                                              id: widget.id!,
                                              dayAdd: selectedDate!,
